...
<div class="container-fluid">
  ...
  <h1><center style="font-family: cursive;font-size: 60px;color:white"><u>Update Organisation  Info...</u></center></h1>
  <br><br>
  <form name=upd action="companyUpdateBean.jsp" method="post" >
	...
	<br>
	<p id="passmsg"></p>
	<a href="organisationHome.html"><button type="submit" class="btn btn-primary btn-lg btn-block">Update</button></a>
  </form>
  <br>
    <a href="organisationConsole.jsp"><button type="button" class="btn btn-primary btn-lg btn-block">Cancel</button></a>
  </div>
